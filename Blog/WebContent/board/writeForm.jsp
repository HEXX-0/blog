        	...
        	<form name="w_form" method="POST" action="<%=request.getContextPath()%>/Board?cmd=board_write">
        		<fieldset class="form-gruop">
        			...
        			<div class="form-gruop">
        				...
        				<textarea id="textAreaContent" rows="15" cols="80" style="width:100%" name="content"></textarea>
        			</div>

        			<button class="btn btn-outline-primary" type="button" onclick="submitContents(this)">Post</button>
        		</fieldset>
        	</form>
        </div>
      </div>
